...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | The Whoops page handler gives the ability to click on a file name and
    | have that file opened directly in the editor provided. By creating
    | this key here, we allow that capability to continue to exist.
    |
    */
    ...
    */
    ...
    'providers' => [
         ...
         */
        Wax\Core\Providers\CoreServiceProvider::class,
    ...
    */
    ...
    'aliases' => [
         ...
         * WAX Aliases
         */
        'Breadcrumbs' => Wax\Core\Facades\Breadcrumbs::class,
        'OgTags' => Wax\Core\Facades\OgTags::class,
