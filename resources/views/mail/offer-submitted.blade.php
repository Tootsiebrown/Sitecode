...
@section('body')
    <table class="email__inner" width="100%" cellpadding="40">
        ...
        <tr>
            <td>
                <h1 class="email__headline">Offer Received!</h1>
                <p>We‘ve received an offer on <a href="{{ $listing->url }}">{{ $listing->title }}</a>.</p>
                <table>
                ...
                <p><a href="{{ route('dashboard.offers.show', ['id' => $offer->id]) }}">Review Offer</a></p>
            </td>
        </tr>
        </tbody>
    </table>
