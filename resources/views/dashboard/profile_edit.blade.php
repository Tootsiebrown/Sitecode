                    ...
                    <div class="col-xs-12">
                        ...
                        <form action="" class="form-horizontal" method="post" enctype="multipart/form-data"> @csrf
                            <div class="form-group {{ $errors->has('firstname')? 'has-error':'' }}">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="firstname" value="{{ old('firstname')? old('firstname') : $user->firstname }}" name="firstname" placeholder="First Name">
                            ...
                            <div class="form-group {{ $errors->has('lastname')? 'has-error':'' }}">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="lastname" value="{{ old('lastname')? old('lastname') : $user->lastname }}" name="lastname" placeholder="Last Name">
