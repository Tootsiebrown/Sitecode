            ...
            <div id="page-wrapper">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8 col-sm-offset-1 col-xs-12">
                        ...
                        <div class="form-group {{ $errors->has('is_rtl')? 'has-error':'' }}">
                            <label class="col-md-4 control-label">@lang('app.enable_disable') </label>
                            <div class="col-md-8">
                                <label for="is_rtl" class="checkbox-inline">
                                    <input type="checkbox" value="1" id="is_rtl" class="disableAjax" name="is_rtl" {{ old('is_rtl') == 1 ? 'checked="checked"': '' }}>
                                    @lang('app.is_rtl')
                                </label>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $language->language_code }}
                                        @if($language->is_rtl == 1)
                                            <label class="label label-success">@lang('app.rtl')</label>
                                        @endif
...
@section('page-js')
    <script>
        $(document).ready(function() {
            ...
            $('input[type="checkbox"]:not(".disableAjax"), input[type="radio"]').click(function () {
