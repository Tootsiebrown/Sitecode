...
<script>
    (adsbygoogle = window.adsbygoogle || []).push({});
                    ...
                    <div class="form-group">
                        <label for="monetize_code_above_categories" class="col-sm-4 control-label">@lang('app.above_categories') </label>
                        <div class="col-sm-8">
                            <textarea name="monetize_code_above_categories" class="form-control">{{ get_option('monetize_code_above_categories') }}</textarea>
                        </div>
                    </div>
