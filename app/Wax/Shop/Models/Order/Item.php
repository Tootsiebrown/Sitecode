 ...
 * @method static \Illuminate\Database\Eloquent\Builder|Item whereBundleId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Item whereCreatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Item whereDimH($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Item whereDimL($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Item whereDimW($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Item whereDiscountAmount($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Item whereDiscountable($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Item whereId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Item whereName($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Item whereOnePerUser($value)
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|Item whereShipmentId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Item whereShippingDisableFreeShipping($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Item whereShippingEnableRateLookup($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Item whereShippingEnableTrackingNumber($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Item whereShippingFlatRate($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Item whereSku($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Item whereTaxable($value)
