 ...
 * @method static \Illuminate\Database\Eloquent\Builder|Shipment whereAddress1($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Shipment whereAddress2($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Shipment whereBoxCount($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Shipment whereBusinessTransitDays($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Shipment whereCity($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Shipment whereCompany($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Shipment whereCountry($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Shipment whereCreatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Shipment whereDesiredDeliveryDate($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Shipment whereEmail($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Shipment whereFirstname($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Shipment whereId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Shipment whereInStorePickup($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Shipment whereLastname($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Shipment whereOrderId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Shipment wherePackaging($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Shipment wherePhone($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Shipment whereSequence($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Shipment whereShippedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Shipment whereShippingCarrier($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Shipment whereShippingDiscountAmount($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Shipment whereShippingServiceActualAmount($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Shipment whereShippingServiceAmount($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Shipment whereShippingServiceCode($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Shipment whereShippingServiceName($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Shipment whereState($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Shipment whereTaxAmount($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Shipment whereTaxDesc($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Shipment whereTaxRate($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Shipment whereTaxShipping($value)
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|Shipment whereZip($value)
 * @mixin \Eloquent
 */
